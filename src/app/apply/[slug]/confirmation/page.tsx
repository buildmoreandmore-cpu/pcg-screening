    ...
    <div className="min-h-dvh bg-off-white">
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-4">
          <p className="text-xs text-gray-500 text-center uppercase tracking-wider mb-2">Your Tracking Code</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-4">
          ...
          <div className="space-y-4">
            {[
              { step: '1', title: 'Screening In Progress', desc: 'Our team is running your background check now.', active: true },
              { step: '2', title: 'Review & Quality Check', desc: 'Results are reviewed for accuracy before delivery.', active: false },
              { step: '3', title: 'Results Delivered', desc: 'Your employer will be notified when results are ready.', active: false },
            ].map((item) => (
        ...
        {/* Package Info */}
        {packageName && (
          <div className="bg-white rounded-xl shadow-sm p-5 mb-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500">Package</p>
              <p className="text-sm font-medium text-navy">{packageName}</p>
            </div>
            <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-blue-50 text-blue-700">In Progress</span>
          </div>
        )}
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-gray-400">
          ...
          Most screenings complete in 1–3 business days
        </div>
